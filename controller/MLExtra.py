...
class MachineLearning():
    ...
    def Confusion_matrix(self):
        ...
        precision = precision_score(self.y_flow_test, self.y_flow_pred)
        recall = recall_score(self.y_flow_test, self.y_flow_pred)
        f1 = f1_score(self.y_flow_test, self.y_flow_pred)
